...
process Lofreq {
    ...
    output:
      ...
      tuple val(base),file("${base}_lofreq.vcf") //into Vcf_ch2
...
process Varscan2 { 
        ...
        input:
            ...
            file SPLITCHR
        output:
            tuple val(base),file("${base}_varscan.vcf") //into Varscan_ch
...
process AnnotateVariants {
        ...
        input:
            tuple val(base),file("${base}_varscan.vcf"),file("${base}_lofreq.vcf") //from Vcf_ch2
            file MAT_PEPTIDES
            file MAT_PEPTIDE_ADDITION
            file RIBOSOMAL_SLIPPAGE
            file RIBOSOMAL_START
