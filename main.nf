...
process Aligning {
    ...
    /usr/local/bin/bbmap.sh in=${base}_cat.fastq.gz outm=${base}.bam ref=${REFERENCE_FASTA} -Xmx6g rgid=\'@RG\\tID:group1\\tSM:${base}\\tPL:illumina\\tLB:lib1\\tPU:unit1\' > bbmap_out.txt 2>&1
